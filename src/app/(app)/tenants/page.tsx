...
export default function TenantsPage() {
  ...
  return (
    <ModulePage
      title="Tenants"
      description="Tenant management, assignment flows, and payment actions will be implemented here."
    >
      ...
      <section className="space-y-4 rounded-lg border border-border-color bg-surface p-4">
        ...
        {tenants.length === 0 ? (
          <EmptyState
            ...
            description="Create tenants in mobile or backend first, then refresh this page."
          />
        ) : (
