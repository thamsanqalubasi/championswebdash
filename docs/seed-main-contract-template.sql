...
CROSS JOIN (
  VALUES
    ...
    (1, 'Parties and Contact Details', '<p style="text-align: justify;"><strong>Landlord:</strong> [Landlord Name &amp; ID — set via "Contract Landlord Information"]</p><p style="text-align: justify;"><strong>Landlord Address:</strong> [Landlord Address]</p><p style="text-align: justify;"><strong>Landlord Contact:</strong> [Landlord Contact]</p><p style="text-align: justify;"><strong>Lessee:</strong> [Tenant Name — auto-filled from selected tenant]</p><p style="text-align: justify;"><strong>Lessee Contact:</strong> [Tenant Email &amp; Phone — from database]</p><p style="text-align: justify;"><strong>Next of Kin:</strong> ____________________</p><p style="text-align: justify;"><strong>Declaration:</strong> The Lessee confirms that all personal information supplied is correct.</p>'),
    (2, 'Property Description', '<p style="text-align: justify;">The Landlord lets to the Lessee, who hires, the following property ("<strong>The Property</strong>"):</p><p style="text-align: justify;"><strong>Residential Accommodation Unit</strong>, located at the designated premises address specified in the lease schedule.</p>'),
    (3, 'Lease Period and Rental', '<p style="text-align: justify;"><strong>Lease Term:</strong> As agreed in the lease schedule.</p><p style="text-align: justify;"><strong>Monthly Rent:</strong> As specified in the financial terms schedule.</p><p style="text-align: justify;">The Lessee agrees to annual escalation aligned with the latest inflation information at the anniversary of this lease.</p>'),
    (4, 'Payment Terms and Banking Details', '<p style="text-align: justify;">Rent is payable by stop order or electronic banking, in advance, on or before the 1st day of each month.</p><p style="text-align: justify;">Where cash deposits are used, the Lessee bears all related banking charges.</p><p style="text-align: justify;"><strong>Bank Details:</strong></p><p style="text-align: justify;">Account Name: John Doe<br/>Account No: 123456789<br/>Bank: Standard Bank<br/>Branch: Central Branch<br/>Branch Code: 123456</p><p style="text-align: justify;">If rental remains unpaid on due date, the Landlord may cancel this lease in writing, resume possession of the property, and pursue arrear rental, damages, and any legal remedies available.</p><p style="text-align: justify;">The Lessee undertakes to pay <strong>10% interest</strong> on rent paid later than the 5th day of the month, payable in that same month.</p>'),
